...
public class ResizeArrows extends EntityModel<Entity> {
...
public ResizeArrows() {
	...
	if (CreatorMinecraftScreen.modelPartTarget >= 0 && CreatorMinecraftScreen.modelPartTarget < modelPartDataList.size()) {
		...
		if (modelPartData.isVisible) {
			...
			red_arrow.texOffs(10, 56).addBox(-53.0F, -7.0F, -5.5F, 7.0F, 11.0F, 11.0F, 0.0F, false);
			...
			blue_arrow.texOffs(14, 60).addBox(-5.5F, -8.0F, -52.5F, 11.0F, 11.0F, 7.0F, 0.0F, false);
			...
			green_arrow.texOffs(10, 56).addBox(-5.5F, -56.0F, -4.75F, 11.0F, 7.0F, 11.0F, 0.0F, false);
		}
	}
}
