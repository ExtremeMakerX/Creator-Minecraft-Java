...
public class DynamicEntityModelEditing extends EntityModelExtension<EntityAbstractMapping> {
	private static final Identifier texture = new Identifier("creatorminecraft:textures/block/white.png");
			...
			for (ModelPartData modelPartData : modelPartDataList) {
				if (modelPartData.main != null) {
					if (modelPartData.isVisible) {
						modelPartData.main = createModelPart();
						modelPartData.main.setPivot(modelPartData.pivotX, modelPartData.pivotY, modelPartData.pivotZ);
						modelPartData.main.setRotation(modelPartData.rotationX, modelPartData.rotationY, modelPartData.rotationZ);
						modelPartData.main.setTextureUVOffset(0, 0).addCuboid(modelPartData.positionX, modelPartData.positionY, modelPartData.positionZ, (int) modelPartData.sizeX, (int) modelPartData.sizeY, (int) modelPartData.sizeZ, modelPartData.inflate, false);
						buildModel();
					}
				}
            }
	...
	public class ModelPartData {
		public ModelPartExtension main = createModelPart();
	...
	public void render(GraphicsHolder matrices, int light, int position) {
			for (ModelPartData modelPartData : modelPartDataList) {
				ModelObjectBase.renderOnce(modelPartData.main, matrices, light, position);
			}
		}
