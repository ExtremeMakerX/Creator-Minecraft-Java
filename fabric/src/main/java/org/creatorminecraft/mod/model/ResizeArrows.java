...
public class ResizeArrows extends EntityModelExtension<EntityAbstractMapping> {
	...
	if (CreatorMinecraftScreen.modelPartTarget >= 0 && CreatorMinecraftScreen.modelPartTarget < modelPartDataList.size()) {
		...
		if (modelPartData.isVisible) {
			...
			red_arrow.setTextureUVOffset(10, 56).addCuboid(-53.0F, -7.0F, -5.5F, (int) 7.0F, (int) 11.0F, (int) 11.0F, 0.0F, false);
			...
			blue_arrow.setTextureUVOffset(14, 60).addCuboid(-5.5F, -8.0F, -52.5F, (int) 11.0F, (int) 11.0F, (int) 7.0F, 0.0F, false);
			...
			green_arrow.setTextureUVOffset(10, 56).addCuboid(-5.5F, -56.0F, -4.75F, (int) 11.0F, (int) 7.0F, (int) 11.0F, 0.0F, false);
		}
	}
}
